...
export default function ContactPage() {
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "1",
      content: "Hello! I'm Wolty's AI assistant. How can I help you with your project today?",
      sender: "bot",
      timestamp: new Date(),
    },
  ])
  ...
  const generateAdvancedBotResponse = async (userMessage: string): Promise<string> => {
    ...
    if (lowerMessage.includes("hello") || lowerMessage.includes("hi") || lowerMessage.includes("hey")) {
      return "Hello! Welcome to Wolty. I'm here to help you explore how we can transform your business through technology. Whether you're looking to build a web application, mobile app, implement AI solutions, or need technical consulting, I can provide detailed information and connect you with our expert team. What brings you here today?"
    }

    // Default intelligent response
    return "That's an excellent question! I'd love to provide you with detailed, personalized information. Our team of experts can address your specific needs and provide comprehensive solutions. You can reach our technical team directly at hello@wolty.com, schedule a free consultation, or continue chatting with me for immediate assistance. What specific aspect of your project would you like to explore further?"
  }
  ...
  const contactInfo = [
    {
      icon: Mail,
      title: "Email",
      value: "hello@wolty.com",
      description: "Send us an email anytime",
      href: "mailto:hello@wolty.com",
    },
    {
      icon: Phone,
      title: "Phone",
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center space-x-2 mb-1">
                        <h3 className="text-xl font-bold">Wolty AI Assistant</h3>
                        <motion.div
