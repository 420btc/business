  ...
  const topClients = [
    {
      ...
      testimonial: {
        quote:
          "Working with Wolty was a game-changer for our product. Their expertise in both hardware and software integration helped us create a seamless experience that our users love.",
        author: "Michael Chen",
        role: "CEO, Nicfound",
      },
    },
    {
      ...
      testimonial: {
        quote:
          "The engineering precision that Wolty brought to our product development process was exceptional. They understood our vision perfectly and delivered beyond our expectations.",
    ...
    },
    {
      ...
      testimonial: {
        quote:
          "The AI capabilities that Wolty built into our platform have transformed how our users communicate. Their technical expertise and innovative approach made all the difference.",
        author: "Alex Rivera",
        role: "CTO, ChatChill",
      },
    },
    {
      ...
      testimonial: {
        quote:
          "Wolty understood the unique challenges of the music industry and built us a platform that truly serves our artists' needs. Their attention to detail and technical prowess is unmatched.",
        author: "Damon Wright",
    ...
    },
    {
      ...
      testimonial: {
        quote:
          "The mobile app Wolty developed for us has completely transformed our business model. The real-time tracking feature has been a game-changer for both our technicians and customers.",
    ...
    },
    {
      ...
      testimonial: {
        quote:
          "Wolty delivered a gaming platform that exceeded all our expectations. Their technical solutions for our complex tournament system were brilliant and our user base has grown exponentially.",
        author: "Marcus King",
