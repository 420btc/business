...
export function ServiceSelectionCard() {
  ...
  if (selectedService && !isCompleted) {
    ...
    return (
      <div className="h-full rounded-lg border border-gray-600 bg-black text-white overflow-hidden">
        {/* Header */}
  ...
  if (isCompleted) {
    return (
      <div className="h-full rounded-lg border border-gray-600 bg-black text-white p-6 flex flex-col justify-center items-center">
