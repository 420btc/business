  ...
  const getServices = () => [
    {
      ...
      icon: <Globe className="w-8 h-8" />,
      features: [
        { icon: <Rocket className="w-5 h-5" />, text: t("features.lightning_fast") },
        { icon: <Shield className="w-5 h-5" />, text: t("features.enterprise_security") },
        { icon: <Target className="w-5 h-5" />, text: t("features.conversion_optimized") },
        { icon: <Gauge className="w-5 h-5" />, text: t("features.uptime_guarantee") },
      ],
      stats: [
        { label: t("stats.speed_increase"), value: "340%" },
        { label: t("stats.conversion_boost"), value: "127%" },
        { label: t("stats.client_satisfaction"), value: "98%" },
      ],
      technologies: ["Next.js", "React", "TypeScript", "Tailwind CSS", "Vercel"],
      gradient: "from-blue-500 via-cyan-400 to-blue-600",
      bgGradient: "from-blue-500/20 via-cyan-400/10 to-blue-600/20",
    ...
    },
    {
      ...
      icon: <Smartphone className="w-8 h-8" />,
      features: [
        { icon: <Users className="w-5 h-5" />, text: t("features.cross_platform") },
        { icon: <Zap className="w-5 h-5" />, text: t("features.real_time_sync") },
        { icon: <Lock className="w-5 h-5" />, text: t("features.advanced_security") },
        { icon: <BarChart className="w-5 h-5" />, text: t("features.built_in_analytics") },
      ],
      stats: [
        { label: t("stats.app_store_rating"), value: "4.8★" },
        { label: t("stats.user_retention"), value: "85%" },
        { label: t("stats.development_speed"), value: "2x Faster" },
      ],
      technologies: ["React Native", "Flutter", "Swift", "Kotlin", "Firebase"],
      gradient: "from-purple-500 via-pink-400 to-purple-600",
      bgGradient: "from-purple-500/20 via-pink-400/10 to-purple-600/20",
    ...
    },
    {
      ...
      icon: <Laptop className="w-8 h-8" />,
      features: [
        { icon: <Cog className="w-5 h-5" />, text: t("features.workflow_automation") },
        { icon: <Database className="w-5 h-5" />, text: t("features.data_integration") },
        { icon: <Cloud className="w-5 h-5" />, text: t("features.cloud_native") },
        { icon: <Layers className="w-5 h-5" />, text: t("features.api_first") },
      ],
      stats: [
        { label: t("stats.efficiency_increase"), value: "250%" },
        { label: t("stats.cost_reduction"), value: "60%" },
        { label: t("stats.error_reduction"), value: "95%" },
      ],
      technologies: ["Node.js", "Python", "AWS", "Docker", "Kubernetes"],
      gradient: "from-emerald-500 via-teal-400 to-emerald-600",
      bgGradient: "from-emerald-500/20 via-teal-400/10 to-emerald-600/20",
    ...
    },
    {
      ...
      icon: <Cog className="w-8 h-8" />,
      features: [
        { icon: <Lightbulb className="w-5 h-5" />, text: t("features.innovative_design") },
        { icon: <Code className="w-5 h-5" />, text: t("features.cad_modeling") },
        { icon: <Package className="w-5 h-5" />, text: t("features.rapid_prototyping") },
        { icon: <Award className="w-5 h-5" />, text: t("features.quality_assurance") },
      ],
      stats: [
        { label: t("stats.design_accuracy"), value: "99.7%" },
        { label: t("stats.time_to_prototype"), value: "72hrs" },
        { label: t("stats.manufacturing_ready"), value: "100%" },
      ],
      technologies: ["SolidWorks", "AutoCAD", "ANSYS", "3D Printing", "CNC"],
      gradient: "from-orange-500 via-red-400 to-orange-600",
      bgGradient: "from-orange-500/20 via-red-400/10 to-orange-600/20",
    ...
    },
    {
      ...
      icon: <Package className="w-8 h-8" />,
      features: [
        { icon: <Target className="w-5 h-5" />, text: t("features.market_research") },
        { icon: <Rocket className="w-5 h-5" />, text: t("features.mvp_development") },
        { icon: <TrendingUp className="w-5 h-5" />, text: t("features.go_to_market") },
        { icon: <Star className="w-5 h-5" />, text: t("features.post_launch") },
      ],
      stats: [
        { label: t("stats.success_rate"), value: "92%" },
        { label: t("stats.time_to_market"), value: "40% Faster" },
        { label: t("stats.roi_average"), value: "3.2x" },
      ],
      technologies: ["Lean Startup", "Agile", "Design Thinking", "Analytics", "A/B Testing"],
      gradient: "from-indigo-500 via-purple-400 to-indigo-600",
      bgGradient: "from-indigo-500/20 via-purple-400/10 to-indigo-600/20",
    ...
    },
    {
      ...
      icon: <Building2 className="w-8 h-8" />,
      features: [
        { icon: <Lightbulb className="w-5 h-5" />, text: t("features.sustainable_design") },
        { icon: <Layers className="w-5 h-5" />, text: t("features.3d_visualization") },
        { icon: <Shield className="w-5 h-5" />, text: t("features.building_compliance") },
        { icon: <Award className="w-5 h-5" />, text: t("features.award_winning") },
      ],
      stats: [
        { label: t("stats.projects_completed"), value: "150+" },
        { label: t("stats.client_satisfaction"), value: "96%" },
        { label: t("stats.on_time_delivery"), value: "98%" },
      ],
      technologies: ["AutoCAD", "Revit", "SketchUp", "3ds Max", "Lumion"],
      gradient: "from-pink-500 via-rose-400 to-pink-600",
      bgGradient: "from-pink-500/20 via-rose-400/10 to-pink-600/20",
                  ...
                  >
                    ...
                    {index === services.length - 1 && (
                      ...
                      >
                        ...
                        >
                          <span className="text-white font-medium">{t("services.section.view_projects")}</span>
                          <motion.div
                            animate={{ x: [0, 5, 0] }}
