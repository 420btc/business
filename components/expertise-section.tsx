      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <motion.div variants={itemVariants} className="group">
              <div className="h-full rounded-lg border border-gray-600 bg-black p-6 hover:border-primary/50 transition-all duration-300 relative overflow-hidden">
            ...
            <motion.div variants={itemVariants} className="group">
              <div className="h-full rounded-lg border border-gray-600 bg-black overflow-hidden hover:border-primary/50 transition-all duration-300 relative">
...
function ViewportTriggered45Percent(): ReactElement {
  ...
  return (
    <div ref={ref} className="relative">
      <h3 className="text-6xl font-bold text-white">{count}%</h3>
...
function ViewportTriggeredCountUp(): ReactElement {
  ...
  return (
    <h3 ref={ref} className="text-5xl font-bold text-white">
      ${count}M
    </h3>
  )
}
